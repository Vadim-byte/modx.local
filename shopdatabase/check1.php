...
$dat = array('PIB' => $PIB, 'Mail' => $Mail, 'Adr' => $Adr,  'Tel' => $Tel,  'IDT' => $IDT,'Mes' => $Mes, ); 
$query = $db->prepare("INSERT INTO $db_table (PIB, Mail, Adr, Tel, IDT, Mes) values (:PIB, :Mail, :Adr, :Tel, :IDT, :Mes)");
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<h1 class="catalogue-title">Оформлення замовлення</h1>
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="checkout-box checkout-box-long">
				...
				<h1 class="catalogue-title">Обрані товари:</h1>
					<tbody>
						<tr>
							<p class="mini-basket-summary">
								<br />
		 ...
		 <div class="col-md-6">
			<div class="checkout-box checkout-box-long">
				...
				<form action="" method="post">
					<p>
						<label for="field-fname">ПІБ <span class="mand">*</span></label>
						<input type="text" id="field-fname" name="PIB">
					</p>
					<p>
						<label for="field-postcode">Email <span class="mand">*</span></label>
						<input type="text" id="field-postcode" name="Mail">
					</p>

					<p>
						<label for="field-city">Адреса <span class="mand">*</span></label>
						<input type="text" id="field-city" name="Adr">
					</p>

					<p>
						<label for="field-phone">Телефон <span class="mand">*</span></label>
						<input type="text" id="field-phone" name="Tel">
					</p>
                    <p>
						<label for="field-phone">Товар який обрали: <span class="mand">*</span></label>
						<input type="text" id="field-phone" name="IDT">
					</p>
                  
							
					<p>
						<label for="field-phone">Додаткова інформація: <span class="mand">*</span></label>
						<input type="text" id="field-phone" name="Mes">
					</p>
                    <div class="form-group">
