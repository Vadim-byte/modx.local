	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="content-box">
				...
				<li> Кожен товар має свій гарантійний термін, і його ви можете здати по гарантії, але якщо ви хочете пришвидшити процедуру, є такі пакети послуг: </li>

				<table>
					<tr>
						<th>Доставка (забрати товар з дому)</th>
						<th>100 - 1000 грн, залежно від розміру товара.</th>
					</tr>
					<tr>
						<td>Стандартна гарантія(3-5 робочих днів)</td>
						<td>Безкоштовно</td>
					</tr>
					<tr>
						<td>Експресс (1-2 робочі дні)</td>
						<td>100 грн.</td>
					</tr>
					<tr>
						<td>Пришвидшена (1 робочий день)</td>
						<td>200 грн</td>
					</tr>
					<tr>
						<td>Максимальна (залежно від складності ремонту, зазвичай 5-10 годин.)</td>
						<td>500 грн</td>
					</tr>
				</table>
