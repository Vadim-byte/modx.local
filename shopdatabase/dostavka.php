	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="content-box">
				...
				<ul>
					<li>Доставка проходить за ваш рахунок.</li>
					<li>Відповідальність за доставку несе пошта.</li>
					<li>Доставка відбуваєтся на протязі 5-ти робочих днів.</li>
					<li>Товар може не відповідати тому, що вказаний на фото.</li>
					<li>Замовити можна будь який товар.</li>
					<li>Працюємо через Нова Пошта, та Укр Пошта</li>
				</ul>
