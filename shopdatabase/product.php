...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<img class="product-image" src="assets/templates/theme/img/p2.jpg" alt="Ibiza Lips" />

			<div class="row">

				<div class="col-md-3">
					<a href=""><img class="product-thumb" src="assets/templates/theme/img/p22.jpg" alt="Ibiza Lips" /></a>
				</div>

				<div class="col-md-3">
					<a href=""><img class="product-thumb" src="assets/templates/theme/img/p222.jpg" alt="Ibiza Lips" /></a>
				</div>
		...
		<div class="col-md-4">
			...
			<h3>Гарантія: <?php echo $product2['Warranty']; echo " місяців";;?></h3>

			<h3>ID товару: <?php echo $product2['id'];?></h3>
			
			<h3>Про товар: <br><?php echo $product2['About'];?></h3>
