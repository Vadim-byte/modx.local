...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<h1><a href="product.php"><?php echo $product5['ProductName'];?></h1>
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<img class="product-image" src="assets/templates/theme/img/p5.jpg" alt="Ibiza Lips" />

			<div class="row">

				<div class="col-md-3">
					<a href=""><img class="product-thumb" src="assets/templates/theme/img/p55.jpg" alt="Ibiza Lips" /></a>
				</div>

				<div class="col-md-3">
					<a href=""><img class="product-thumb" src="assets/templates/theme/img/p555.jpg" alt="Ibiza Lips" /></a>
				</div>
		...
		<div class="col-md-4">
			...
			<h3 class="catalogue-title">Вартість: <?php echo $product5['Price']; echo " грн";?></h3>

			<h3>Гарантія: <?php echo $product5['Warranty']; echo " місяців";;?></h3>

			<h3>ID товару: <?php echo $product5['id'];?></h3>
			
			<h3>Про товар: <br><?php echo $product5['About'];?></h3>
