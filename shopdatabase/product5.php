...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<h1><a href="product.php"><?php echo $product2['ProductName'];?></h1>
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<img class="product-image" src="assets/templates/theme/img/p6.jpg" alt="Ibiza Lips" />

			<div class="row">

				<div class="col-md-3">
					<a href=""><img class="product-thumb" src="assets/templates/theme/img/p66.jpg" alt="Ibiza Lips" /></a>
				</div>

				<div class="col-md-3">
					<a href=""><img class="product-thumb" src="assets/templates/theme/img/p666.jpg" alt="Ibiza Lips" /></a>
				</div>
		...
		<div class="col-md-4">
			...
			<h3 class="catalogue-title">Вартість: <?php echo $product6['Price']; echo " грн";?></h3>

			<h3>Гарантія: <?php echo $product6['Warranty']; echo " місяців";;?></h3>

			<h3>ID товару: <?php echo $product6['id'];?></h3>
			
			<h3>Про товар: <br><?php echo $product6['About'];?></h3>
